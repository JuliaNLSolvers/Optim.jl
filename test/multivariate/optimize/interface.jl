@testset "interface" begin
    ...
    @test AcceleratedGradientDescent(alphaguess=1.0)).alphaguess! isa LineSearches.InitialStatic
    @test BFGS(alphaguess=1.0)).alphaguess! isa LineSearches.InitialStatic
    @test ConjugateGradient(alphaguess=1.0)).alphaguess! isa LineSearches.InitialStatic
    @test GradientDescent(alphaguess=1.0)).alphaguess! isa LineSearches.InitialStatic
    @test MomentumGradientDescent(alphaguess=1.0)).alphaguess! isa LineSearches.InitialStatic
    @test Newton(alphaguess=1.0)).alphaguess! isa LineSearches.InitialStatic
